...
NN_LIST_SUB_STRINGS = ['russia.txt', 'france.txt']
NA_LIST_SUB_STRINGS = ['us.txt', 'australia.txt', 'ireland.txt']
LINE_FROM_CLASS = 200000
MINIMUM_ROW_LENGTH = 25
MAXIMUM_ROW_LENGTH = 150
BASE_REGULAR = '5way_rus_fra_usa_aus_ire_200K_{}-{}'.format(MINIMUM_ROW_LENGTH, MAXIMUM_ROW_LENGTH)
...
USE_TMP_FOLDER = True
MAKE_NEW_DATA_FILE = True  # if this is True, main will not run. a new CSV.ZIP will be created. change the params
IS_TRAIN = True
SHOULD_SAVE = True
